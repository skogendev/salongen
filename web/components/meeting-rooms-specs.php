	...
	<div class="container">
		<div class="u-flexgrid-g justify-between">
			<div class="col-12 lg:col-5 wysiwyg">
				<h2 class="heading-lg">Tekniske spesifikasjoner</h2>
				...
				<table class="table-specs">
					...
					<tr>
						<td>Passer for</td>
						<td>Opptil 18 personer</td>
					</tr>
					<tr>
						<td>Teknikk</td>
						<td>Med rommet følger en 60” presentasjonstv, med installert videokamera for kameraoverføring. En del annet følger også med, og det står i denne teksten.</td>
					</tr>
					<tr>
						<td>Fasiliteter</td>
						<td>Toaletter i andre etasje. Dagslys fra store vinduer mot Tollbugata</td>
					</tr>
					<tr>
						<td>Servering</td>
						<td>Litt tekst om maten. <a href="#">Se mer informasjon om mat & drikke.</a></td>
					</tr>
				</table>
			</div>
			<div class="col-12 lg:col-5 wysiwyg">
