  ...
  <div class="container">
    <div class="u-flexgrid-g justify-between">
      <div class="col-12 lg:col-6">
        <div class="overflow-hidden"><img src="/assets/img/tmp15.jpg" class="mb-one-col lazyload lazyload-img"></div>
        <div class="overflow-hidden"><img src="/assets/img/tmp17.jpg" class="pl-one-col lazyload lazyload-img"></div>
      </div>
      <div class="col-12 lg:col-5">
        <div class="mt-16 mb-16">
          <div class="heading-sm text-eple mb-4">Møterom <br> 2-8 personer</div>
          <h1 class="heading-xl mb-6">Lunden</h1>
